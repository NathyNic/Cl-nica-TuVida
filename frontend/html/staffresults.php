            ...
            <form action="./staffresults.php" method="post">
                <div class="row justify-content-center" id="busqueda" style="margin-top: 5px;">
                    ...
                    <div class="col-3 d-flex justify-content-center text-center">
                        <input type="text" class="form-control" id="dr_name" name="dr_name" placeholder="Nombre y/o apellido" style="text-align: center;">
                    </div>
                    <div class="col-3">
                        <input id="btnBuscar" type="submit" value="Buscar" name="buscar" placeholder="Buscar">
                    </div>
                </div>
            </form>
        </div>
